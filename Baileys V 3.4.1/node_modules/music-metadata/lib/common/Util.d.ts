 ...
 */
export declare function getBitAllignedNumber(buf: Buffer, byteOffset: number, bitOffset: number, len: number): number;
/**
 * Read bit-aligned number start from buffer
 * Total offset in bits = byteOffset * 8 + bitOffset
 * @param buf Byte buffer
 ...
 * @return {number} decoded bit aligned number
 */
export declare function isBitSet(buf: Buffer, byteOffset: number, bitOffset: number): boolean;
